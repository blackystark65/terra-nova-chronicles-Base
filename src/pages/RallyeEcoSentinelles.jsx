  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-green-950 to-emerald-950">
      ...
      <main className="pt-20 pb-32 px-4 max-w-4xl mx-auto">
        ...
        {activeTab === 'regles' && (
          <div className="p-4 rounded-3xl bg-slate-900/80 border border-emerald-400/20">
            <h2 className="text-2xl font-black text-white mb-5">📋 Règles — Rallye des Éco-Sentinelles</h2>
            <ReglesView />
          </div>
        )}
